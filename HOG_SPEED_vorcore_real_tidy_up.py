...
epislon_list_find_offset, eigvec_list_no_used = test_near_pi_epsilon(8, 8, 50, 1, 3.5, y_real_calculation)
     #H2NyNx_xyOBC_time_vor_core(N_y, N_x, t, a_0, x_0_real, y_0_real, s_0)
...
#%%                                                         
                                                                 #4, 4, 1
def Rho_sites_all_epsilons_noVor(N_x, N_y, num_time_stages, a_0, x_0, y_0, s_0, list_of_sites_needed): # this will return a list in order of epsilon_n
...
Rho, Epsilon = Rho_sites_all_epsilons(8, 8, t_sampling, 1, 4, 4, 1, list_of_sites_around_mid_8) # it seems the more time sampled, the larger the bulk structure(that range of Epsilon)'s Rho 2ND FUNC CALLED
